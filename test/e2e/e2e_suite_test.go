...
var (
	...
	managerImage = "example.com/podbeacon:v0.0.1"
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting podbeacon e2e test suite\n")
	RunSpecs(t, "e2e suite")
}

var _ = BeforeSuite(func() {
	By("verifying we are running against the expected kind cluster")
